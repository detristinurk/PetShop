...
@section('content')
  <div class="box">
      <div class="box-header">
        ...
        <a href="produk/create" class="btn btn-info btn-md pull-right"><i class="fa fa-plus"> Tambah</i> </a>
      </div>
      <!-- /.box-header -->
      <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$data->stok}}</td>
              <td>{{$data->foto}}</td>
              <td> <a href="produk/{{$data->id}}/edit" class="btn btn-xs btn-warning">Edit</a>
              <form class="" action="produk/{{$data->id}}" method="post">
              {{ csrf_field() }}
              {{ method_field('DELETE') }}
