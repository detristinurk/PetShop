...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"> <b>K</b><b>A</b>K</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>KakPetShop</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{URL::asset('adminlte/dist/img/paws.png')}}" class="user-image" alt="User Image">
              <span class="hidden-xs"> Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{URL::asset('adminlte/dist/img/paws.png')}}" class="img-circle" alt="User Image">

                <p>
                  Admin - Admin
                  <small>Kak PetShop - Quality PetShop</small>
                </p>
              </li>
              <li class="user-body">
                <div class="row">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/admin/kategori"><i class="fa fa-cube"></i> Kategori</a></li>
            <li><a href="/admin/produk"><i class="fa fa-cubes"></i> Produk</a></li>
            <li><a href="/admin/supplier"><i class="fa fa-truck"></i>Supplier</a></li>
          </ul>
        </li>
      </ul>
    </section>
